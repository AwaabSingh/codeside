...
<nav>
    ...
    <ul>
        ...
        <li class=''> 
            <a href="/register" class="text-xl bg-lgblue px-4 uppercase py-3 rounded-xl hover:bg-drblue shadow text-white">Sign Up</a>
        </li>
        <li class=''>
...
<!-- <nav class='p-5 bg-white shadow md:flex md:items-center md:justify-between'>
        ...
        <div class='flex justify-between items-center'>
            ...
            <!-- <span class="text-3x cursor-pointer md:hidden block mx-2" on:click="{navburger}"  >
        ...
        <ul class='md:flex md:items-center z-[-1] md:z-auto md:static absolute bg-white w-full left-0 md:w-auto md:py-0 py-4 md-pl-0 pl-7 md:opacity-100 opacity-0 [-400px] transition-all ease-in duration-500' >
