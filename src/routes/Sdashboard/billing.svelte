                ...
                <table class="sm:table-fixed w-full divide-y font-medium">
                    ...
                    <tbody class="divide-y">
                        <tr>
                            ...
                            <td class="whitespace-nowrap py-4"><span>2021-05-14 <span class="md:inline hidden"> 12:31:34 </span></span></td>
                            <td class="whitespace-nowrap py-4 text-right"><span class="bg-red-100 text-red-600 font-semibold px-3 py-1 rounded-full text-sm">Not Paid</span></td>
                            <td class="whitespace-nowrap py-4 text-right"><span>$24.00</span></td>
                            <td class="whitespace-nowrap py-4 text-right"><span class="border font-semibold px-3.5 py-1.5 rounded-md text-sm">Download PDF</span></td>
                        </tr>
                        <tr>
                            <td class="whitespace-nowrap py-4"><span>621345</span></td>
                            <td class="whitespace-nowrap py-4"><span>2021-05-14 <span class="md:inline hidden"> 12:31:34 </span></span></td>
                            <td class="whitespace-nowrap py-4 text-right"><span class="bg-yellow-100 text-yellow-600 font-semibold px-3 py-1 rounded-full text-sm">Pending</span></td>
                        ...
                        <tr>
                            <td class="whitespace-nowrap py-4"><span>621345</span></td>
                            <td class="whitespace-nowrap py-4"><span>2021-05-14 <span class="md:inline hidden"> 12:31:34 </span> </span></td>
                            <td class="whitespace-nowrap py-4 text-right"><span class="bg-green-100 text-green-600 font-semibold px-3 py-1 rounded-full text-sm">Success</span></td>
