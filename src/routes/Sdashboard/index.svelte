      ...
      <div class='flex-1 m-5'>
           <div>
            ...
            <div id="default-carousel" data-carousel="slide" class="relative">
                ...
                <img src="/inst.jpeg" class="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2" alt="...">
                </div>
                ...
                <div class="container ">
                    <h1 class='mt-10 text-gray-500 font-bold text-3xl mb-5' >Featured Classes</h1>
                   
                    <div class="bg-white shadow-lg rounded-lg uk-transition-toggle md:flex">
                        <div class="md:w-5/12 md:h-60 h-40 overflow-hidden rounded-l-lg relative">
                            ...
                            <img src="../assets/images/icon-play.svg" class="w-16 h-16 uk-position-center uk-transition-fade" alt="">
                        </div>
                        <div class="flex-1 md:p-6 p-4">
                            <div class="font-semibold line-clamp-2 md:text-xl md:leading-relaxed text-gray-400"> Learn JavaScript and Express to become a professional JavaScript developer. </div>
                            ...
                            <div class="font-semibold mt-3 text-black-400"> John Michael </div>
