     ...
     {:else}
       <section>
        <div class="h-screen bg-gray-300 ">
            <div class="py-12 md:px-10 px-3">
                <div class="max-w-md mx-auto bg-gray-100 shadow-lg rounded-lg md:max-w-5xl">
                    <div class="md:flex ">
                        <div class="w-full p-4 px-5 py-3">
                            <div class="md:grid md:grid-cols-3 gap-2 ">
                                <div class="col-span-4 md:p-10">
                                   <div class='flex justify-between items-center'>
                                    <h1 class="text-xl font-medium text-drblue">Shopping Cart</h1>
                                    <a class='bg-drblue px-3 py-3 shadow rounded-lg text-white hover:bg-lgblue ' href="/checkout">Proceed To Checkout</a>
                                   </div>
                                    ...
                                    <div class="flex justify-between items-center mt-6 pt-6">
                                        ...
                                        <div class="flex justify-center items-center">
                                            ...
                                            <div class="pr-8 "> <span class="text-xs font-medium">${cart.price}</span> </div>
                                            <div> 
